...
prefix="/home/user/hostcwd/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/other_builds/python3/arm64-v8a__ndk_target_24/python3/android-build/android-root"
exec_prefix="${prefix}"
...
LIBPL=$(echo "$(prefix)/lib/python3.14/config-$(VERSION)$(ABIFLAGS)-aarch64-linux-android" | sed "s#$prefix#$prefix_real#")
SO=".cpython-314-aarch64-linux-android.so"
PYTHONFRAMEWORK=""
